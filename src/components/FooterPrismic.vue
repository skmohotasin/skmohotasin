            ...
            <div class="social-media">
              <ul class="list-group list-group-horizontal ms-xl-5 mb-lg-0 mt-4 mt-sm-0 pt-sm-1 pt-md-4">
                <li class="text-lg-start text-md-start text-mb-start list-group-item bg-transparent border-0 m-0 p-1">
                  <a class="text-white text-decoration-none btn-circle" href="https://www.facebook.com/" alt="Facebook" target="_blank" rel="noopener">
                ...
                <li class="text-lg-start text-md-start text-mb-start list-group-item bg-transparent border-0 m-0 p-1">
                  <a class="text-white text-decoration-none btn-circle" href="https://www.instagram.com/" alt="Instagram" target="_blank" rel="noopener">
                ...
                <li class="text-lg-start text-md-start text-mb-start list-group-item bg-transparent border-0 m-0 p-1">
                  <a class="text-white text-decoration-none btn-circle" href="https://www.linkedin.com/" alt="Linkedin" target="_blank" rel="noopener">
...
.colored-text {color: rgb(219, 59, 86);}
